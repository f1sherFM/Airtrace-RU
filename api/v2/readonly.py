"""Current v2 readonly routes backed by shared application services."""
...
@router.get("/v2/current", response_model=AirQualityData)
...
@router.get("/v2/forecast", response_model=list[AirQualityData])
...
@router.get("/v2/history", response_model=HistoryQueryResponse)
...
@router.get("/v2/health", response_model=HealthCheckResponse)
