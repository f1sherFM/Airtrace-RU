...
# Кастомный HTMLResponse с явной кодировкой UTF-8
class UTF8HTMLResponse(HTMLResponse):
    """HTMLResponse с явной установкой charset=utf-8"""
    
    def __init__(self, content: Any = None, **kwargs):
        super().__init__(content=content, **kwargs)
        # Явно устанавливаем charset=utf-8
...
# Middleware для установки правильной кодировки в HTML ответах
@app.middleware("http")
async def add_charset_to_html(request: Request, call_next):
    """Добавление charset=utf-8 к HTML ответам для корректного отображения кириллицы"""
    response = await call_next(request)
    
    # Если это HTML ответ, добавляем charset=utf-8
...
# Настройка шаблонов с явной кодировкой UTF-8
templates = Jinja2Templates(directory="templates")
# Устанавливаем кодировку для Jinja2
...
if __name__ == "__main__":
    # Явно указываем кодировку для stdout/stderr
    import sys
