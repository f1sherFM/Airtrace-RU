...
### 🖥️ Деплой на VPS (Production)

#### Быстрый деплой с Docker

```bash
# 1. Клонирование на VPS
git clone https://github.com/f1sherFM/Airtrace-RU.git
cd Airtrace-RU
...
#### 📖 Подробные руководства по деплою

**Начните здесь:** [DEPLOY_README.md](DEPLOY_README.md) - навигация по всей документации

- ⚡ [QUICKSTART.md](QUICKSTART.md) - деплой за 5 минут
- 📖 [DEPLOYMENT.md](DEPLOYMENT.md) - полное руководство с troubleshooting
- 🖥️ [VPS_SETUP.md](VPS_SETUP.md) - настройка VPS с нуля
- 🔌 [API_EXAMPLES.md](API_EXAMPLES.md) - примеры использования API
- 📝 [CHEATSHEET.md](CHEATSHEET.md) - шпаргалка по всем командам
- 📦 [DEPLOYMENT_FILES.md](DEPLOYMENT_FILES.md) - обзор файлов деплоя
- ✅ [DEPLOYMENT_SUMMARY.md](DEPLOYMENT_SUMMARY.md) - резюме и следующие шаги
...
- 📊 **Экспорт данных** — скачивание в CSV и JSON форматах
- 📈 **История данных** — просмотр динамики за 1-7 дней на сайте
