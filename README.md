...
**Пример CSV:**
```csv
timestamp,city,latitude,longitude,aqi_value,aqi_category,pm2_5,pm10,no2,so2,o3,nmu_risk,temperature,humidity,wind_speed
2026-01-19T09:00:00,Магнитогорск,53.4069,58.9794,42,Хорошее,8.1,11.2,15.3,2.1,45.7,low,5.2,68.3,3.4
```
